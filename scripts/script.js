...
//const btnAlignment = document.getElementByClass('alignment');
    ...
    btnLeft.addEventListener('click', changeTextAlign)
    btnCenter.addEventListener('click', changeTextAlign)
    btnRight.addEventListener('click', changeTextAlign)
